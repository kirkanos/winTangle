...
Delete removes one. The global hotkeys are inactive while that window is open —
otherwise pressing a combination that is already bound would simply run it
instead of recording it. A combination already used elsewhere moves to the action it
