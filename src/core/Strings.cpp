...
constexpr std::array<Entry, static_cast<size_t>(Str::Count_)> kStrings{{
    ...
    {Str::SettingsNewCombination, "New combination:", "Neue Kombination:"},
    {Str::SettingsAssign, "Assign", "Zuweisen"},
    ...
    {Str::SettingsHoldModifier, "Hold a modifier (Ctrl/Alt/Shift/Win)",
     "Mit Modifier drücken (Ctrl/Alt/Shift/Win)"},
    {Str::SettingsUnbound, "—", "—"},
